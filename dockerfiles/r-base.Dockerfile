# Define BUILD args.
ARG UBUNTU_VERSION
ARG UBUNTU_IMAGE_REPO

FROM ${UBUNTU_IMAGE_REPO:-ubuntu}:${UBUNTU_VERSION:-noble}
...
ENV R_BASE_IMAGE_REPO=${R_BASE_IMAGE_REPO:-dncr/r-base}
ENV RSTUDIO_IMAGE_REPO=${RSTUDIO_IMAGE_REPO:-dncr/rstudio-server}
